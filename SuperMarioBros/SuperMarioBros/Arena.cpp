...
{
	const double accelaration = 9.8; // adjust number in the future
	bool onTop = false;
	for (int i = 0; i < movingObjects_.size(); i++)
	{
		onTop = false;
...
void Arena::pushBack(const MovingObject& movingObject)
{
	movingObjects_.push_back(movingObject);
}

void Arena::pushBack(const Object& object)
{
